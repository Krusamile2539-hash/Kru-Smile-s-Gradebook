...
import { Smile, ArrowRight, Folder, ChevronRight, Plus, LayoutGrid, ArrowLeft, Eye, EyeOff, Loader2, FileSpreadsheet, Link as LinkIcon, HelpCircle, PlayCircle, CloudUpload, CheckCircle2, Copy, X, BookOpen, Menu } from 'lucide-react';
