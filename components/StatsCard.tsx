...
const StatsCard: React.FC<StatsCardProps> = ({ totalStudents, averageGPA, highestTotal }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6 mb-6">
      {/* Students Card */}
      <div className="bg-sky/30 p-4 md:p-6 rounded-bubble shadow-pop flex items-center gap-4 border-4 border-white">
      ...
      {/* Average GPA Card */}
      <div className="bg-mint/40 p-4 md:p-6 rounded-bubble shadow-pop flex items-center gap-4 border-4 border-white">
      ...
      {/* Highest Score Card */}
      <div className="bg-lemon p-4 md:p-6 rounded-bubble shadow-pop flex items-center gap-4 border-4 border-white">
